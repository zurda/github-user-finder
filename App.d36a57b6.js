...
},{"react":"../node_modules/react/index.js","warning":"../node_modules/warning/browser.js","prop-types":"../node_modules/prop-types/index.js","invariant":"../node_modules/invariant/browser.js","create-react-context":"../node_modules/create-react-context/lib/index.js","react-lifecycles-compat":"../node_modules/react-lifecycles-compat/react-lifecycles-compat.es.js","./lib/utils":"../node_modules/@reach/router/es/lib/utils.js","./lib/history":"../node_modules/@reach/router/es/lib/history.js"}],"../public/logo.png":[function(require,module,exports) {
...
},{"react":"../node_modules/react/index.js","../public/logo.png":"../public/logo.png","@reach/router":"../node_modules/@reach/router/es/index.js"}],"../node_modules/github-username-regex/module.js":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _default = /^[a-z\d](?:[a-z\d]|-(?=[a-z\d])){0,38}$/i;
exports.default = _default;
...
function getProfile(username) {
  return _axios.default.get("https://api.github.com/users/" + username + params).then(function (user) {
    return user.data;
  });
}
...
var _default = api;
exports.default = _default;
},{"axios":"../node_modules/axios/index.js"}],"helpers.js":[function(require,module,exports) {
"use strict";
...
},{}],"UserCard.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(UserCard, [{
    ...
    value: function render() {
      ...
      var _this$props$user = this.props.user,
          ...
          stargazers = _this$props$user.stargazers,
          followers = _this$props$user.followers,
          repos = _this$props$user.repos;
      return _react.default.createElement("div", {
        ...
        className: "header"
      }, title, _react.default.createElement("br", null), username), _react.default.createElement("div", {
        className: "description"
      }, _react.default.createElement("p", null, bio)), _react.default.createElement("div", {
        className: "extra",
        style: {
          color: "#A0A0A0"
        }
      }, _react.default.createElement("span", null, "Location:"), location, _react.default.createElement("p", {
        style: {
          color: "#FF1493"
        }
      }, hireable ? "Availble for job offers" : null)), _react.default.createElement("div", {
        className: "extra content"
      }, _react.default.createElement("span", null, _react.default.createElement("i", {
        className: "star icon"
      }), (0, _helpers.addCommas)(stargazers), " Stargazers"), _react.default.createElement("span", null, _react.default.createElement("i", {
        className: "users icon"
      }), (0, _helpers.addCommas)(followers), " Followers"), _react.default.createElement("span", null, _react.default.createElement("i", {
        className: "file code outline icon"
        ...
        onClick: function onClick() {
          return _this.props.handleDelete(username);
        }
      }, "Discard")))));
    }
  }]);
...
exports.default = _default;
},{"react":"../node_modules/react/index.js","./helpers":"helpers.js","@reach/router":"../node_modules/@reach/router/es/index.js"}],"DisplayUsersList.js":[function(require,module,exports) {
"use strict";
...
var DisplayUsersList =
/*#__PURE__*/
function (_React$Component) {
  _inherits(DisplayUsersList, _React$Component);

  function DisplayUsersList() {
    _classCallCheck(this, DisplayUsersList);

    return _possibleConstructorReturn(this, _getPrototypeOf(DisplayUsersList).apply(this, arguments));
  }

  _createClass(DisplayUsersList, [{
    key: "render",
    value: function render() {
      var _this = this;
      ...
      if (!this.props.users) {
        ...
        userComponents = users.map(function (user) {
...
var Sorting = function Sorting(props) {
  return _react.default.createElement("form", {
    ...
    htmlFor: "sorting"
  }, "Sort results by: "), _react.default.createElement("div", {
    className: "field",
    id: "sorting"
  }, _react.default.createElement("div", {
    ...
    htmlFor: "stargazers"
  }, "Stargazers"))), _react.default.createElement("div", {
    className: "field"
  }, _react.default.createElement("div", {
    className: "ui radio checkbox"
  }, _react.default.createElement("input", {
...
var _githubUsernameRegex = _interopRequireDefault(require("github-username-regex"));
...
function (_React$Component) {
  ...
  _createClass(Main, [{
    ...
    value: function deleteUser(username) {
      var usersData = this.state.usersData.filter(function (obj) {
    ...
    value: function clickHandler() {
      ...
      if (_githubUsernameRegex.default.test(currentInput) && currentUsers.indexOf(currentInput) === -1 && !this.state.currentApiCall) {
        this.setState({
          currentApiCall: true
        });

        _api.default.getData(currentInput).then(function (userData) {
          var newState = {
            input: "",
            currentApiCall: false
          };
          ...
          if (userData !== null) {
            newState.usersData = _this2.state.usersData.concat(userData);
    ...
    key: "render",
    value: function render() {
      var showSorting = this.state.usersData.length > 1;
      return _react.default.createElement("div", {
        className: "main"
      }, _react.default.createElement("div", {
      ...
      }), _react.default.createElement(_DisplayUsersList.default, {
        sortBy: this.state.sortBy,
  ...
  _createClass(UserDetails, [{
    ...
    value: function componentDidMount() {
      ...
      if (_githubUsernameRegex.default.test(username) && !this.state.currentApiCall) {
        ...
        _api.default.getData(username).then(function (userData) {
          if (userData !== null) {
            _this2.setState({
              userData: userData,
              currentApiCall: false
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        href: "https://github.com/".concat(this.state.userData.username)
      }, _react.default.createElement("i", {
        className: "star icon",
        title: "Stargazers"
      })), _react.default.createElement("span", null, this.state.userData.stargazers), _react.default.createElement("a", {
        href: "https://github.com/".concat(this.state.userData.username, "?tab=followers"),
        target: "_blank",
        rel: "noopener noreferrer"
      }, _react.default.createElement("i", {
        className: "users icon",
        title: "Followers"
      })), _react.default.createElement("span", null, this.state.userData.followers), _react.default.createElement("a", {
        href: "https://github.com/".concat(this.state.userData.username, "?tab=repositories"),
        target: "_blank",
        rel: "noopener noreferrer"
      }, _react.default.createElement("i", {
        className: "file code outline icon",
        title: "Repositories"
      })), _react.default.createElement("span", null, this.state.userData.repos), _react.default.createElement("i", {
        ...
        className: "description"
      }, _react.default.createElement("h4", null, this.state.userData.title, _react.default.createElement("br", null), _react.default.createElement("a", {
        href: "https://github.com/".concat(this.state.userData.username),
        target: "_blank",
        rel: "noopener noreferrer"
      }, this.state.userData.username)), _react.default.createElement("p", null, this.state.userData.bio)), _react.default.createElement("div", {
        className: "extra"
      }, _react.default.createElement("span", null, "Location this:"), this.state.userData.location, _react.default.createElement("span", {
        style: {
          display: "block",
          color: "green"
        }
...
exports.default = _default;
},{"react":"../node_modules/react/index.js","github-username-regex":"../node_modules/github-username-regex/module.js","./api":"api.js"}],"About.js":[function(require,module,exports) {
"use strict";
...
var About = function About() {
  return _react.default.createElement("div", {
    className: "about"
  }, _react.default.createElement("h4", null, "Hi, my name is Michal."), _react.default.createElement("p", null, "I'm an aspiring Web Developer, and I'm passionate about building intuitive and beautiful UI's."), _react.default.createElement("p", null, "I'm an Ex-journalist and self taught programmer. I began my career transition a couple of years ago as part of a group called SheCodes. Since then, I've leanred HTML, CSS, JavaScript, and Python, which lead me to a role in a startup that teaches Data Science. I helped students make a similar transition into computer science related fields, which was extremely rewarding. I fell in love with working on websites' code and discovering their structure, and my goal is to keep learning so that I could build simple yet beautiful UI's."));
};
...
var Footer = function Footer() {
  ...
  }, _react.default.createElement("p", null, "Created by", " ", _react.default.createElement("a", {
    href: "https://zurda.github.io/portfolio/",
    target: "_blank",
    rel: "noopener noreferrer"
  }, "Michal Weizman"), _react.default.createElement("br", null), "This site code is available on", " ", _react.default.createElement("a", {
