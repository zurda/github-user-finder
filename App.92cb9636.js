...
module.exports = "/logo.a9dc2bb3.png";
...
var Header = function Header() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("img", { className: "logo", src: _logo2.default, alt: "Github Profile Display Logo" }),
      _react2.default.createElement(
        "h1",
        { className: "title" },
        "Github Profiles"
...
exports.default = /^[a-z\d](?:[a-z\d]|-(?=[a-z\d])){0,38}$/i;
...
function getProfile(username) {
  return _axios2.default.get("https://api.github.com/users/" + username + params).then(function (user) {
    return user.data;
  });
}

function getRepos(username) {
  return _axios2.default.get("https://api.github.com/users/" + username + "/repos" + params + "&per_page=100").then(function (repos) {
    return repos.data;
  });
}
...
function getUserData(user) {
  return _axios2.default.all([getProfile(user), getRepos(user)]).then(function (data) {
    var profile = data[0];
    var repos = data[1];
...
exports.default = api;
},{"axios":"../node_modules/axios/index.js"}],"UserCard.js":[function(require,module,exports) {
"use strict";
...
var UserCard = function (_React$Component) {
  ...
  _createClass(UserCard, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "item", id: username, key: id },
        _react2.default.createElement(
          "div",
          { className: "ui small image" },
          _react2.default.createElement("img", { src: avatarUrl, alt: "User avatar" })
        ),
        _react2.default.createElement(
          "div",
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "span",
              null,
              _react2.default.createElement("i", { className: "star icon" }),
              stargazers,
              " Stargazers"
            ),
            _react2.default.createElement(
...
},{"react":"../node_modules/react/index.js","@reach/router":"../node_modules/@reach/router/es/index.js"}],"DisplayUsersList.js":[function(require,module,exports) {
"use strict";
...
var DisplayUsersList = function (_React$Component) {
  _inherits(DisplayUsersList, _React$Component);

  function DisplayUsersList() {
    _classCallCheck(this, DisplayUsersList);

    return _possibleConstructorReturn(this, (DisplayUsersList.__proto__ || Object.getPrototypeOf(DisplayUsersList)).apply(this, arguments));
  }
...
var Sorting = function Sorting(props) {
  var displaySort = props.length > 1 ? "visible" : "hidden";
  return _react2.default.createElement(
    "form",
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "label",
            { htmlFor: "repos", onChange: props.change },
            "Repos"
          )
        )
      )
...
var _githubUsernameRegex = require("github-username-regex");

var _githubUsernameRegex2 = _interopRequireDefault(_githubUsernameRegex);
    ...
    value: function clickHandler() {
      ...
      if (_githubUsernameRegex2.default.test(currentInput) && currentUsers.indexOf(currentInput) === -1 && !this.state.currentApiCall) {
        ...
        _api2.default.getData(currentInput).then(function (userData) {
          if (userData !== null) {
            var joined = _this2.state.usersData.concat(userData);
            _this2.setState({
              input: "",
              usersData: joined,
              currentApiCall: false
...
var UserDetails = function (_React$Component) {
  ...
  _createClass(UserDetails, [{
    ...
    value: function componentDidMount() {
      ...
      if (_githubUsernameRegex2.default.test(username) && !this.state.currentApiCall) {
        this.setState({ currentApiCall: true });
        _api2.default.getData(username).then(function (userData) {
          if (userData !== null) {
            _this2.setState({
              userData: userData,
              currentApiCall: false
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement("i", { className: "star icon", title: "Stargazers" })
            ),
            _react2.default.createElement(
              "span",
              null,
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement("i", { className: "users icon", title: "Followers" })
            ),
            _react2.default.createElement(
              "span",
              null,
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement("i", { className: "file code outline icon", title: "Repositories" })
            ),
            _react2.default.createElement(
              "span",
              null,
...
var About = function About() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "p",
      null,
      "I'm an aspiring Web Developer, and I'm passionate about building intuitive and beautiful UI's."
    ),
    _react2.default.createElement(
      "p",
      null,
...
//# sourceMappingURL=/App.92cb9636.map